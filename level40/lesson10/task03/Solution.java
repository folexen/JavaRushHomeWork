...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year) {
        ...
        return new DateTime(fmt1.parseDateTime(year).getYear(), fmt.parseDateTime(birthday).getMonthOfYear(),
                fmt.parseDateTime(birthday).getDayOfMonth(), 0, 0).dayOfWeek().getAsText(Locale.ITALIAN);

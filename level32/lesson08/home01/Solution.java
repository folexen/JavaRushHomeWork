...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        SomeInterfaceWithMethods someInterfaceWithMethodsProxy = (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, interfaces, customInvocationHandler);

        return someInterfaceWithMethodsProxy;
    }
}
